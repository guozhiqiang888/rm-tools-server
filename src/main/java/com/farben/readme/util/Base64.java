...
public class Base64 {
    ...
    static final private byte[] base64Alphabet = new byte[Base64.BASELENGTH];
    static final private char[] lookUpBase64Alphabet = new char[Base64.LOOKUPLENGTH];
    ...
    static {
        ...
        for (int i = 0; i <= 25; i++) {
            Base64.lookUpBase64Alphabet[i] = (char) ('A' + i);
        }

        for (int i = 26, j = 0; i <= 51; i++, j++) {
            Base64.lookUpBase64Alphabet[i] = (char) ('a' + j);
        }

        for (int i = 52, j = 0; i <= 61; i++, j++) {
            Base64.lookUpBase64Alphabet[i] = (char) ('0' + j);
        }
        Base64.lookUpBase64Alphabet[62] = (char) '+';
        Base64.lookUpBase64Alphabet[63] = (char) '/';
    ...
    public static void main(final String[] args) throws UnsupportedEncodingException {
        String str = "wfTPwsTjtcTBqs+1t73KvaGj";
        str = "warPtbvjt+E=";
        String outStr = new String(Base64.decode(str), "GBK");
